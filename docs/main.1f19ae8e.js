...
if (!gl.getProgramParameter(program, gl.LINK_STATUS)) console.log(gl.getProgramInfoLog(program)); // piu

program.uColor = gl.getUniformLocation(program, "uTime");
gl.uniform1f(program.uColor, 1.0); // pow
...
require("./style.css");
},{"./webgl":"webgl.js","./style.css":"style.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
